...
def generate_launch_description():
    ...
    # Path to dynamic mode configuration
    dynamic_config_path = '/home/abdullah/workspaces/career_sprint/awsim-autonomous-research/config/dynamic_path_planner_params.yaml'
    
    # Path planner node in dynamic mode
